...
const campaigns: Campaign[] = [
  { id: '1', title: 'Campagne 1', image: '/placeholder.svg' },
  { id: '2', title: 'Campagne 2', image: '/placeholder.svg' },
  { id: '3', title: 'Campagne 3', image: '/placeholder.svg' },
  { id: '4', title: 'Campagne 4', image: '/placeholder.svg' },
]

export function SectionDigitalCampaigns() {
  return (
        ...
        <div className="mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="mb-6 sm:mb-0">
            ...
            <p className="text-gray-300 text-sm sm:text-base">
              Design graphique, visuels, motion design, social media, etc.
            </p>
          </div>
